...
import { TypeOrmTasksRepository } from './repositories/typeorm-tasks-repository'
...
import { TypeOrmTaskCommentsRepository } from './repositories/typeorm-task-comments-repository'
import { TypeOrmTaskAssigneesRepository } from './repositories/typeorm-task-assignees-repository'
import { TypeOrmTaskAuditLogsRepository } from './repositories/typeorm-task-audit-logs-repository'
